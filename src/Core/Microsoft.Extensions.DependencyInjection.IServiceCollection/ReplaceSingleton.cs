...
public static partial class Extensions
{
    ...
    ///     and adds a singleton service of the type specified in <paramref name="serviceType" />
    ...
    public static IServiceCollection ReplaceSingleton(this IServiceCollection services, Type serviceType, Type implementationType)
    {
        ...
        return Replace(services, serviceType, implementationType, ServiceLifetime.Singleton);
    }
    ...
    /// <returns>A reference to this instance after the operation has completed.</returns>
    public static IServiceCollection ReplaceSingleton(this IServiceCollection services, Type serviceType,
        Func<IServiceProvider, object> implementationFactory)
    {
        ...
        return Replace(services, serviceType, implementationFactory, ServiceLifetime.Singleton);
    }

    /// <summary>
    ///     Removes the first service with the same service type if exists.
    ///     and adds a singleton service of the type specified in <paramref name="serviceType" /> to the specified
    ///     <see cref="IServiceCollection" />.
    /// </summary>
    /// <param name="services">The <see cref="IServiceCollection" /> to replace the service to.</param>
    /// <param name="serviceType">The type of the service to register.</param>
    ...
    public static IServiceCollection ReplaceSingleton(this IServiceCollection services, Type serviceType)
    {
        ...
        if (serviceType == null)
            throw new ArgumentNullException(nameof(serviceType));
        return services.ReplaceSingleton(serviceType, serviceType);
    }

    /// <summary>
    ///     Removes the first service with the same <typeparamref name="TService" /> if exists.
    ///     and adds a singleton service of the type specified in with an implementation type specified
        ...
        Func<IServiceProvider, TImplementation> implementationFactory) where TService : class where TImplementation : class, TService
    {
        ...
        if (implementationFactory == null)
            throw new ArgumentNullException(nameof(implementationFactory));
        return services.ReplaceSingleton(typeof(TService), implementationFactory);
    }

    /// <summary>
    ///     Removes the first service with the same <typeparamref name="TService" /> if exists.
    ///     And adds a singleton service of the type specified in with an implementation type to the specified
    ///     <see cref="IServiceCollection" />.
    /// </summary>
    /// <typeparam name="TService">The type of the service to add.</typeparam>
    /// <typeparam name="TImplementation">The type of the implementation to use.</typeparam>
    /// <param name="services">The <see cref="IServiceCollection" /> to replace the service to.</param>
    /// <returns>A reference to this instance after the operation has completed.</returns>
    public static IServiceCollection ReplaceSingleton<TService, TImplementation>(this IServiceCollection services) where TService : class
    ...
    /// <summary>
    ///     Removes the first service with the same <typeparamref name="TService" /> if exists.
    ///     And adds a singleton service of the type specified in to the specified
    ///     <see cref="IServiceCollection" />.
    /// </summary>
    /// <typeparam name="TService">The type of the service to add.</typeparam>
    /// <param name="services">The <see cref="IServiceCollection" /> to replace the service to.</param>
    ...
    public static IServiceCollection ReplaceSingleton<TService>(this IServiceCollection services) where TService : class
    {
        if (services == null)
            throw new ArgumentNullException(nameof(services));
        return services.ReplaceSingleton(typeof(TService));
    }
