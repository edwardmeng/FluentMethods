...
{
    /// <summary>
    /// Returns an specified array which represents a subset of the elements in the source array.
    /// </summary>
    ...
    /// <returns>An specified array which represents a subset of the elements in the source array.</returns>
    ...
    /// </exception>
    public static T[] Slice<T>(this T[] sourceArray, int startIndex, int length)
    {
        if (sourceArray == null)
        {
