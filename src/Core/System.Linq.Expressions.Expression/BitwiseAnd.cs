...
public static partial class Extensions
{
    ...
    /// <returns>A <see cref="BinaryExpression"/> represents the bitwise <c>AND</c> operation of the left and right operand.</returns>
    ...
    public static BinaryExpression BitwiseAnd(this Expression left, Expression right)
    {
