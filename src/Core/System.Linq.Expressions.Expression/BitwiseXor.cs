...
public static partial class Extensions
{
    ...
    /// <returns>A <see cref="BinaryExpression"/> represents the bitwise <c>XOR</c> operation of the left and right operand.</returns>
    ...
    public static BinaryExpression BitwiseXor(this Expression left, Expression right)
    {
