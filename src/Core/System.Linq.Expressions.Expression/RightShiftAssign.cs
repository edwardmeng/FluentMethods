...
public static partial class Extensions
{
    ...
    /// <returns>A <see cref="BinaryExpression"/> represents the a bitwise right-shift assignment operation of the left and right operand.</returns>
    /// <exception cref="System.ArgumentNullException"><paramref name="left"/> or <paramref name="right"/> is null.</exception>
    /// <exception cref="System.InvalidOperationException">The right-shift operator is not defined for the type of <paramref name="left"/> and <paramref name="right"/>.</exception>
