...
public static partial class Extensions
{
    ...
    /// <summary>
    /// Creates a <see cref="BinaryExpression"/> that represents a conditional <c>AND</c> operation that evaluates the second operand only if the first operand evaluates to <c>true</c>.
    /// </summary>
    ...
    /// <returns>A <see cref="BinaryExpression"/> represents the conditional <c>AND</c> operation of the left and right operands.</returns>
    /// <exception cref="System.ArgumentNullException"><paramref name="left"/> or <paramref name="right"/> is null.</exception>
    /// <exception cref="System.InvalidOperationException">The conditional <c>AND</c> operator is not defined for the type of <paramref name="left"/> and <paramref name="right"/>.</exception>
