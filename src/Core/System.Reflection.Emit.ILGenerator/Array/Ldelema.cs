...
public static partial class Extensions
{
    ...
    /// <param name="il">The <see cref="T:System.Reflection.Emit.ILGenerator" /> to emit instructions from</param>
    /// <param name="type">The type of elements in the array</param>
    public static ILGenerator Ldelema(this ILGenerator il, System.Reflection.TypeInfo type) => il.Ldelema(type?.AsType());
    ...
    /// <param name="type">The type of elements in the array</param>
    /// <param name="index">The index of the element to load the address of</param>
    public static ILGenerator Ldelema(this ILGenerator il, System.Reflection.TypeInfo type, uint index) => il.Ldelema(type?.AsType(), index);
