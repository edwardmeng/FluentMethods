...
public static partial class Extensions
{
    ...
    /// <param name="il">The <see cref="ILGenerator" /> to emit instructions from</param>
    /// <param name="type">The type of elements in the array</param>
    public static ILGenerator Ldelem(this ILGenerator il, TypeInfo type) => il.Ldelem(type?.AsType());
    ...
    /// <param name="type">The type of elements in the array</param>
    /// <param name="index">The index of the element to load</param>
    public static ILGenerator Ldelem(this ILGenerator il, TypeInfo type, uint index) => il.Ldelem(type?.AsType(), index);
