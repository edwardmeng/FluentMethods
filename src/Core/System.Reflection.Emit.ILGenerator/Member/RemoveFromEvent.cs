...
public static partial class Extensions
{
    ...
    public static ILGenerator RemoveFromEvent(this ILGenerator il, EventInfo @event)
    {
        ...
        return il.Call(@event.GetRemoveMethod(true));
    }
    ...
    /// <param name="type">The type the event is on</param>
    /// <param name="eventName">The name of the event</param>
    public static ILGenerator RemoveFromEvent(this ILGenerator il, TypeInfo type, string eventName)
        => il.RemoveFromEvent(type?.AsType(), eventName);
#endif
}