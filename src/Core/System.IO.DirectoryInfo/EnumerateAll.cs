...
public static partial class Extensions
{
    ...
    public static IEnumerable<string> EnumerateAll(this DirectoryInfo @this)
    {
    ...
    /// 
    ///                   // Exemples
    ///                   List&lt;string&gt; result = root.EnumerateAll().ToList();
    /// 
    ///                   // Unit Test
    ...
    /// ###
    /// <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
    public static IEnumerable<string> EnumerateAll(this DirectoryInfo @this, string searchPattern)
    {
    ...
    /// ###
    /// <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
    public static IEnumerable<string> EnumerateAll(this DirectoryInfo @this, string searchPattern, SearchOption searchOption)
    {
    ...
    ///     <see
    ///         cref="M:System.IO.Path.GetInvalidPathChars" />
    ///     .- or -<paramref name="searchPatterns" /> does not contain a valid pattern.
    /// </exception>
    /// ###
    /// <exception cref="T:System.ArgumentNullException">
    ///     <paramref name="this" /> is null.-or-
    ///     <paramref name="searchPatterns" /> is null.
    /// </exception>
    /// ###
    /// <exception cref="T:System.IO.DirectoryNotFoundException">
    ///     <paramref name="this" /> is invalid, such as
    ...
    /// ###
    /// <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
    public static IEnumerable<string> EnumerateAll(this DirectoryInfo @this, string[] searchPatterns)
    {
    ...
    /// ###
    /// <exception cref="T:System.UnauthorizedAccessException">The caller does not have the required permission.</exception>
    public static IEnumerable<string> EnumerateAll(this DirectoryInfo @this, string[] searchPatterns, SearchOption searchOption)
    {
