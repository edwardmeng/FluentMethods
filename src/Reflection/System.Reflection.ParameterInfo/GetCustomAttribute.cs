...
public static partial class Extensions
{
    ...
    public static T GetCustomAttribute<T>(this ParameterInfo parameter) where T : Attribute
    {
        return (T)parameter.GetCustomAttribute(typeof(T));
    }
    ...
    public static Attribute GetCustomAttribute(this ParameterInfo parameter, Type attributeType)
    {
        return Attribute.GetCustomAttribute(parameter, attributeType);
    }
