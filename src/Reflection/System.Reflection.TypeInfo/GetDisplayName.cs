...
{
    public static string GetDisplayName(this TypeInfo type, string defaultValue = null)
    {
        return type.GetDisplayName(() => defaultValue);
    }

    public static string GetDisplayName(this TypeInfo type, Func<string> defaultValueFactory)
    {
        if (type == null)
        {
