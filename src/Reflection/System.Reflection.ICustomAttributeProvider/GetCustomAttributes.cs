...
{
    /// <summary>
    /// Retrieves a collection of custom attributes that are applied to a specified <see cref="ICustomAttributeProvider"/>, and optionally inspects the ancestors of that <see cref="ICustomAttributeProvider"/>.
    /// </summary>
    ...
    /// <summary>
    /// Retrieves a collection of custom attributes of a specified type that are applied to a specified <see cref="ICustomAttributeProvider"/>, and optionally inspects the ancestors of that <see cref="ICustomAttributeProvider"/>.
    /// </summary>
