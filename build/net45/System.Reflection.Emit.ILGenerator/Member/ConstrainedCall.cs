...
public static partial class Extensions
{
    ...
    /// <param name="constrainedType">The type to constrain the call to</param>
    /// <param name="expression">The expression representing the method to call</param>
    public static ILGenerator ConstrainedCall<T1, T2, T3, T4, T5, T6, T7, T8>(this ILGenerator il, Type constrainedType,
    ...
    /// <param name="constrainedType">The type to constrain the call to</param>
    /// <param name="expression">The expression representing the method to call</param>
    public static ILGenerator ConstrainedCall<T1, T2, T3, T4, T5, T6, TResult>(this ILGenerator il, Type constrainedType,
    ...
    /// <param name="constrainedType">The type to constrain the call to</param>
    /// <param name="expression">The expression representing the method to call</param>
    public static ILGenerator ConstrainedCall<T1, T2, T3, T4, T5, T6, T7, TResult>(this ILGenerator il, Type constrainedType,
    ...
    /// <param name="constrainedType">The type to constrain the call to</param>
    /// <param name="expression">The expression representing the method to call</param>
    public static ILGenerator ConstrainedCall<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(this ILGenerator il, Type constrainedType,
