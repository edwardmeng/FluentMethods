...
public static partial class Extensions
{
    ...
    public static ILGenerator LoadElementAddress(this ILGenerator il, Type type)
    {
        if (il == null)
    ...
    /// <param name="il">The <see cref="T:System.Reflection.Emit.ILGenerator" /> to emit instructions from</param>
    public static ILGenerator LoadElementAddress<T>(this ILGenerator il) => il.LoadElementAddress(typeof(T));
    ...
    public static ILGenerator LoadElementAddress(this ILGenerator il, Type type, uint index)
    {
        return il.LoadConst(index).LoadElementAddress(type);
    }
    ...
    /// <param name="il">The <see cref="T:System.Reflection.Emit.ILGenerator" /> to emit instructions from</param>
    /// <param name="index">The index of the element to load the address of</param>
    public static ILGenerator LoadElementAddressAtIndex<T>(this ILGenerator il, uint index)
    {
        return il.LoadConst(index).LoadElementAddress(typeof(T));
    }
}