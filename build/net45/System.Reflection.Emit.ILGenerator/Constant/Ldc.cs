...
public static partial class Extensions
{
    ...
    public static ILGenerator Ldc(this ILGenerator il, decimal value)
    {
        ...
        if (decimal.Truncate(value) == value)
        {
            if ((int.MinValue <= value) && (value <= int.MaxValue))
                return il.Ldc(decimal.ToInt32(value)).New(typeof(decimal).GetConstructor(new[] { typeof(int) }));
            if ((long.MinValue <= value) && (value <= long.MaxValue))
                return il.Ldc(decimal.ToInt64(value)).New(typeof(decimal).GetConstructor(new[] { typeof(long) }));
        }
    ...
    public static ILGenerator Ldc(this ILGenerator il, DateTime value)
    {
        if (il == null)
            throw new ArgumentNullException(nameof(il));
        return il.Ldc(value.Ticks).New(typeof(DateTime).GetConstructor(new[] { typeof(long) }));
    }
