...
public static partial class Extensions
{
    ...
    /// <param name="il">The <see cref="T:System.Reflection.Emit.ILGenerator" /> to emit instructions from</param>
    /// <param name="value">The value to compare to the evaluation stack value</param>
    public static ILGenerator CompareLessThanUnsigned(this ILGenerator il, int value)
    {
        return il.LoadConst(value).CompareLessUnsigned();
    }
    ...
    /// <param name="il">The <see cref="T:System.Reflection.Emit.ILGenerator" /> to emit instructions from</param>
    /// <param name="value">The value to compare to the evaluation stack value</param>
    public static ILGenerator CompareLessThanUnsigned(this ILGenerator il, long value)
    {
        return il.LoadConst(value).CompareLessUnsigned();
    }
    ...
    /// <param name="il">The <see cref="T:System.Reflection.Emit.ILGenerator" /> to emit instructions from</param>
    /// <param name="value">The value to compare to the evaluation stack value</param>
    public static ILGenerator CompareLessThanUnsigned(this ILGenerator il, float value)
    {
        return il.LoadConst(value).CompareLessUnsigned();
    }
    ...
    /// <param name="il">The <see cref="T:System.Reflection.Emit.ILGenerator" /> to emit instructions from</param>
    /// <param name="value">The value to compare to the evaluation stack value</param>
    public static ILGenerator CompareLessThanUnsigned(this ILGenerator il, double value)
    {
        return il.LoadConst(value).CompareLessUnsigned();
    }
}