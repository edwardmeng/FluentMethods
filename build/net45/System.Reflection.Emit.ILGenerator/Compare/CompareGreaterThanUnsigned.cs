...
public static partial class Extensions
{
    ...
    /// <param name="il">The <see cref="T:System.Reflection.Emit.ILGenerator" /> to emit instructions from</param>
    /// <param name="value">The value to compare to the evaluation stack value</param>
    public static ILGenerator CompareGreaterThanUnsigned(this ILGenerator il, byte value)
    {
        return il.LoadConst(value).CompareGreaterUnsigned();
    }
    ...
    /// <param name="il">The <see cref="T:System.Reflection.Emit.ILGenerator" /> to emit instructions from</param>
    /// <param name="value">The value to compare to the evaluation stack value</param>
    public static ILGenerator CompareGreaterThanUnsigned(this ILGenerator il, ushort value)
    {
        return il.LoadConst(value).CompareGreaterUnsigned();
    }
