...
public static partial class Extensions
{
    ...
    public static ILGenerator SubtractUnsignedChecked(this ILGenerator il, char value)
    {
    ...
    /// <param name="il">The <see cref="T:System.Reflection.Emit.ILGenerator" /> to emit instructions from</param>
    /// <param name="value">The value to subtract from the evaluation stack value</param>
    public static ILGenerator SubtractUnsignedChecked(this ILGenerator il, byte value)
    {
        return il.LoadConst(value).SubtractUnsignedChecked();
    }
    ...
    /// <param name="il">The <see cref="T:System.Reflection.Emit.ILGenerator" /> to emit instructions from</param>
    /// <param name="value">The value to subtract from the evaluation stack value</param>
    public static ILGenerator SubtractUnsignedChecked(this ILGenerator il, ushort value)
    {
        return il.LoadConst(value).SubtractUnsignedChecked();
    }
