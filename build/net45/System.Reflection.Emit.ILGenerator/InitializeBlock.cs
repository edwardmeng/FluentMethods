...
public static partial class Extensions
{
    ...
    public static ILGenerator InitializeBlock(this ILGenerator il)
    {
        if (il == null)
    ...
    public static ILGenerator InitializeBlock(this ILGenerator il, byte value, uint bytes)
    {
        return il.LoadConst(value).LoadConst(bytes).InitializeBlock();
    }
}