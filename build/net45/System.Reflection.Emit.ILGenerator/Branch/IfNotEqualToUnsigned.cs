...
{
    private static ILGenerator IfNotEqualToUnsigned<T>(this BranchILGenerator il, T value)
    {
    ...
    public static ILGenerator IfNotEqualToUnsigned(this BranchILGenerator il, bool value) => il.IfNotEqualToUnsigned<bool>(value);
